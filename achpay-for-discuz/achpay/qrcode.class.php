...
class QRspec {
	...
	public static function debug($frame, $binary_mode = false) {
		if ($binary_mode) {
			...
			echo '<style>.m{background-color:#fff}</style>';
			...
			echo '<style>.p{background-color:#ff0}.m{background-color:#0F0}.s{background-color:red}.c{background-color:#0ff}.x{background-color:pink}.f{background-color:gold}</style>';
			echo "<pre><tt>";
			echo join("<br/ >", $frame);
			echo "</tt></pre>";
		}
